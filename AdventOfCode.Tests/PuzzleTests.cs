...
namespace AdventOfCode.Tests
{
    ...
    public class PuzzleTests
    {
        ...
        public static IEnumerable<NUnit.Framework.TestCaseData> GetTestCases()
        {
            ...
            yield return new TestCaseData(2015, 19, 2).SetExpectedResult(212);
            yield return new TestCaseData(2015, 20, 1).SetExpectedResult(786240);
            yield return new TestCaseData(2015, 20, 2).SetExpectedResult(831600);
            yield return new TestCaseData(2015, 21, 1).SetExpectedResult(111);
            yield return new TestCaseData(2015, 21, 2).SetExpectedResult(188);
            ...
            yield return new TestCaseData(2018, 3, 1).SetExpectedResult(100261);
            yield return new TestCaseData(2018, 3, 2).SetExpectedResult(251);
            yield return new TestCaseData(2018, 4, 1).SetExpectedResult(26281);
            yield return new TestCaseData(2018, 4, 2).SetExpectedResult(73001);
            yield return new TestCaseData(2018, 5, 1).SetExpectedResult(10132);
            yield return new TestCaseData(2018, 5, 2).SetExpectedResult(4572);
            ...
            yield return new TestCaseData(2025, 1, 1).SetExpectedResult(1100);
            yield return new TestCaseData(2025, 1, 2).SetExpectedResult(6358);
            yield return new TestCaseData(2025, 2, 1).SetExpectedResult(22062284697);
            yield return new TestCaseData(2025, 2, 2).SetExpectedResult(46666175279);
            yield return new TestCaseData(2025, 3, 1).SetExpectedResult(16946);
            yield return new TestCaseData(2025, 3, 2).SetExpectedResult(168627047606506);
            yield return new TestCaseData(2025, 4, 1).SetExpectedResult(1564);
            yield return new TestCaseData(2025, 4, 2).SetExpectedResult(9401);
            yield return new TestCaseData(2025, 5, 1).SetExpectedResult(525);
            yield return new TestCaseData(2025, 5, 2).SetExpectedResult(333892124923577);
            yield return new TestCaseData(2025, 6, 1).SetExpectedResult(6417439773370);
            yield return new TestCaseData(2025, 6, 2).SetExpectedResult(11044319475191);
            yield return new TestCaseData(2025, 7, 1).SetExpectedResult(1609);
            yield return new TestCaseData(2025, 7, 2).SetExpectedResult(12472142047197);
            yield return new TestCaseData(2025, 8, 1).SetExpectedResult(66640);
            yield return new TestCaseData(2025, 8, 2).SetExpectedResult(78894156);
            yield return new TestCaseData(2025, 9, 1).SetExpectedResult(4755064176);
        }
    }
}
