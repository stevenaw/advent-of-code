...
namespace AdventOfCode2020.Dec17
{
    class Puzzle2 : AdventPuzzle
    {
        protected override long Solve(IEnumerable<string> lines)
        {
            ...
            {
                int minX = Int32.MaxValue, minY = Int32.MaxValue, minZ = Int32.MaxValue, minW = Int32.MaxValue;
                int maxX = Int32.MinValue, maxY = Int32.MinValue, maxZ = Int32.MinValue, maxW = Int32.MinValue;
